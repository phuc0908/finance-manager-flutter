...
const TransactionEntitySchema = CollectionSchema(
  ...
  properties: {
    ...
    r'type': PropertySchema(
      ...
      name: r'type',
      type: IsarType.byte,
      enumMap: _TransactionEntitytypeEnumValueMap,
    ),
...
TransactionEntity _transactionEntityDeserialize(
  ...
  final object = TransactionEntity(
    ...
    receiptImageUrl: reader.readStringOrNull(offsets[6]),
    type:
        _TransactionEntitytypeValueEnumMap[reader.readByteOrNull(offsets[7])] ??
...
P _transactionEntityDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 6:
      return (reader.readStringOrNull(offset)) as P;
    case 7:
      return (_TransactionEntitytypeValueEnumMap[
...
const _TransactionEntitytypeEnumValueMap = {
  'income': 0,
  'expense': 1,
};
const _TransactionEntitytypeValueEnumMap = {
...
extension TransactionEntityQueryProperty
  ...
  QueryBuilder<TransactionEntity, String, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionEntity, bool, QQueryOperations> isSyncedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<TransactionEntity, String, QQueryOperations> walletIdProperty() {
    return QueryBuilder.apply(this, (query) {
